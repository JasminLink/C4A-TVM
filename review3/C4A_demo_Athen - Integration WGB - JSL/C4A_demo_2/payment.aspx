        ...
        <div id="display" runat="server" class="payment_C4A">
            ...
            <div id="container">
                <div id="linksstepbystep">
                    ...
                    <br />
                    <br />
                    <div id="headlineelement">
                        <asp:Label runat="server" ID="choice"></asp:Label></div>
                    <br />
                ...
                <div id="rechtsstepbystep">
                    ...
                    <br />
                    <br />
                    <div id="fktextb" class="fktextbg">
                        <asp:Label runat="server" ID="ticket_dest"></asp:Label></div>
                    <div id="fktextb" class="fktextbg">
                        <asp:Label runat="server" ID="ticket_type"></asp:Label></div>
                    <div id="fktextb" class="fktextbg">
                        <asp:Label runat="server" ID="ticket_tarif"></asp:Label></div>
                    <div id="fktextb" class="fktextbg">
                        <asp:Label runat="server" ID="add_service_value">jhghg</asp:Label></div>
                    ...
                    <br />
                    <br />
                    <div id="amount_label" runat="server" style="text-align: right;">
                        <asp:Label runat="server" ID="total_price_label"></asp:Label></div>
                    <div style="text-align: right;">
                        <asp:Label runat="server" ID="total_price"></asp:Label></div>
                    <div style="text-align: right; font-size: 40px; padding-top: 20px;"></div>
                    <div id="amount" runat="server" style="text-align: right; font-size: 40px; padding-top: 20px;">
                        <asp:Label runat="server" ID="price"></asp:Label></div>
                </div>
            </div>
            ...
            <div id="footer">
                ...
                <asp:Timer runat="server" ID="timeout_ticker" Interval="3000"
                    OnTick="timeout_ticker_Tick">
                </asp:Timer>

                <asp:LinkButton ID="ccl" runat="server" CssClass="button_eng_normal" OnClick="ccl_Click">
                    <asp:Label runat="server" ID="cancel_label"></asp:Label></asp:LinkButton>
                ...
                <asp:LinkButton runat="server" ID="navigate_ahead"
                    ...
                    OnClick="navigate_ahead_Click">
                    <asp:Label runat="server" ID="ahead_label">Bezahlen</asp:Label>
                </asp:LinkButton>

                <asp:LinkButton runat="server" ID="navigate_back" NavigateUrl="#"
                    CssClass="button_eng_normal" Style="position: absolute; left: 548px"
                    OnClick="navigate_back_Click">
                    <asp:Label runat="server" ID="back_label"></asp:Label>
                </asp:LinkButton>
