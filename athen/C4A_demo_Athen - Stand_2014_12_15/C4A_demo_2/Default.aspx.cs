...
namespace C4A_demo_2
{
    ...
    public partial class _Default : System.Web.UI.Page
    {
        ...
        protected void startButton_Click(object sender, EventArgs e)
        {
            ...
            if (ts.TVMPreferences.contrastTheme == "yellow-black")
                        {
                            ...
                            this.runjQueryCode("$('.button_eng_normal_gpii').switchClass('button_eng_normal_gpii','button_eng_contrast_eservice','slow');");
            ...
            //if(ts.TVMPreferences.language.Contains("fr"))
           // {
         ...
         //   }
                        ...
                        if (ts.TVMPreferences.contrastTheme == "default")
                        {
                            //startButton.Visible = false;
                            ...
                            this.runjQueryCode("$('.button_eng_contrast_gpii').switchClass('button_eng_contrast_gpii','button_eng_normal_gpii','slow');");
                        ...
                        if(ts.TVMPreferences.language.Contains("de"))
                        {
                            Global.current_language = "de";
                        }

                        if (ts.TVMPreferences.language.Contains("en"))
                        {
                        ...
                        if (ts.TVMPreferences.language.Contains("es"))
                        {
                            Global.current_language = "es";
                        }

                        if (ts.TVMPreferences.language.Contains("it"))
                        {
                            Global.current_language = "it";
                        }

                        if (ts.TVMPreferences.language.Contains("el"))
                        {
