...
<div id="display" runat="server" class="touristbg_C4A">
    ...
    <br/><br/><br/><br/>
      	...
      	<div id="headlineelement" style="position: absolute; top:182px; left:668px;"><asp:Label runat="server" ID="ttheader"></asp:Label></div>
      	      	...
      	      	<div id="Div1" style="position: absolute; top:258px; left:668px; "><asp:Label  width="275px" runat="server" ID="tt_description_1" style="line-height:22px"></asp:Label></div>
