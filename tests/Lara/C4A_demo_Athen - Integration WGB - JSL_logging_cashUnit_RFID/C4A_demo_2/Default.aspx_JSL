...
<div id="display" class="startseite_C4A" style="width: 1024px; height:768px;">
    ...
    <div id="container">
        ...
        <asp:LinkButton runat="server" id="DesignSwitch" NavigateUrl="#" CssClass="button_eng_normal" 
        ...
        <asp:LinkButton runat="server" id="startButton" NavigateUrl="#" CssClass="button_eng_normal_eservice"
                    onclick="startButton_Click"><div style="padding-left: 30px; vertical-align:middle; ">GPII</div></asp:LinkButton> 
